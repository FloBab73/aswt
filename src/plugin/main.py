...
from src.adapter.PygameEngine import PygameGameEngine, PygameGraphicsEngine
...
GameManager(event_handler, game_engine, graphics_engine, BlocksGenerator(FileExtractor()))
